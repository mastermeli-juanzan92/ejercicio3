...
<div class="col-md-4 mb-3 md-form">
    ...
    <form class="form-group" name="myForm" id="myForm" novalidate class="needs-validation">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="site_id" id="site_id" placeholder="ingrese un id del sitio" value="MLA" required>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="payment_method" id="payment_method" placeholder="ingrese un metodo de pago"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  name="off_set" id="off_set" placeholder="ingrese el off set" value="0">
        </div>
